            ...
            <div class="row justify-content-center">
                <div class="col-9 col-lg-7">
                    <form class="px-5 box-body" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-item">
                            <i class="fa-solid fa-envelope" style="color: #f39b20;"></i>
                            <label for="email"></label>
                            <input name="email" type="email" placeholder="Email" required></input>
                        </div>
                        <div class="form-item">
                            <i class="fa-solid fa-phone" style="color: #f39b20;"></i>
                            <label for="phone"></label>
                            <input name="phone" type="tel" placeholder="Phone" required></input>
                        </div>
                        <div class="form-item">
                        ...
                        <div class="form-item">
                            ...
                            <input name="password-confirm" type="password" placeholder="Retype password" required></input>
                        </div>
